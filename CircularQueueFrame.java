...
public class CircularQueueFrame extends JFrame {
	private int[] queue;        // Array to simulate the circular queue
    ...
    public CircularQueueFrame() {
        ...
        createButton.addActionListener(e -> {
            try {
                ...
                rear = -1;
                count = 0;
                JOptionPane.showMessageDialog(this, "Circular Queue of size " + size + " got created!");
        ...
        backButton.addActionListener(e -> {
            dispose(); // Close the current Circular Queue frame
